      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            ...
            words="Turning Ideas into Impactful Full Stack Experiences"
          />
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl z-10 relative">
            Hey! I&apos;m Fatma, a full stack developer with a knack for
            creating immersive, high-performance applications.
          </p>
          <a href="#about">
            <MagicButton
              title="Show my work"
